...
public class Info extends GridPane implements Initializable {
    ...
    @FXML
    private Text name_T, version_T, author_T, itemPerHourLabel_T, itemCountLabel_T, itemPerHour_T, itemCount_T, runtime_T, currentAction_T;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        itemPerHourLabel_T.textProperty().set("Clicks per hour: ");
        itemCountLabel_T.textProperty().set("Clicks: ");
        setVisible(true);
    }
    ...
    public Info(SuperCookingGuildDoor bot) {
        this.bot = bot;
        ...
        Future<InputStream> stream = bot.getPlatform().invokeLater(() -> Resources.getAsStream("com/SuperBotter/bots/SuperCookingGuildDoor/ui/Info.fxml"));
